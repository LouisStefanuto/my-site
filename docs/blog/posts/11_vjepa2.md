...
> Now that you have the fundamentals of JEPA, let's jump directly to V-JEPA 2, which is basically the same as V-JEPA 1[^3] but with more data and bigger ViT models.
